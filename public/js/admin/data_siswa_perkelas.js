...
var Main = /*#__PURE__*/function (_Core) {
  ...
  _createClass(Main, [{
    ...
    value: function setDataTableSiswa(requestIdTahunAjar) {
      var _this2 = this;
    ...
    key: "fetchTahunAjar",
    value: function () {
      var _fetchTahunAjar = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
        var self, url;
                  ...
                  return _regeneratorRuntime().wrap(function _callee2$(_context2) {
                    while (1) switch (_context2.prev = _context2.next) {
                      ...
                      case 2:
                        ...
                        _context2.next = 5;
                        return self.setDataTableSiswa(self.tahunAjarSelected);
                      case 5:
                        self.fetchNamaKelas(self.tahunAjarSelected);
                      case 6:
                      case "end":
