...
var Main = /*#__PURE__*/function (_Core) {
  ...
  _createClass(Main, [{
    ...
    key: "setInputSiswa",
    value: function setInputSiswa(id_tahun_ajar) {
      var id_kelas = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "";
      var self = this; // Simpan referensi this dalam variabel self

      // Assigmen data yang diperlukan untuk mengakses API
      var url = "".concat(self.mainURL, "/api/rekening/siswa-belum-terdaftar?id_tahun_ajar=").concat(id_tahun_ajar, "&id_kelas=").concat(id_kelas);
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 3;
                return self.idTahunAjar.find(":selected").val();
              case 3:
                self.tahunAjarSelected = _context.sent;
                _context.next = 6;
                return self.setInputSiswa(self.tahunAjarSelected);
              case 6:
                self.fetchNamaKelas(self.tahunAjarSelected);
              case 7:
              case "end":
        ...
        var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(response) {
          ...
          return _regeneratorRuntime().wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              ...
              case 3:
                _context2.next = 5;
                return self.optionsList("nama kelas", self.idKelas, data);
              case 5:
              case "end":
