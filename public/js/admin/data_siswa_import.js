...
var Main = /*#__PURE__*/function (_Core) {
  ...
  _createClass(Main, [{
    ...
    value: function setListeners() {
      var self = this;
      self.form.submit( /*#__PURE__*/function () {
          ...
          return _regeneratorRuntime().wrap(function _callee2$(_context2) {
            while (1) switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 5;
                return formData.append("excel_file", $("#excel-file")[0].files[0]);
              case 5:
                _context2.next = 7;
                return self.progressBar.css("width", "15%");
              case 7:
                _context2.next = 9;
                return formData.append("jenis_login", "admin");
              case 9:
                _context2.next = 11;
                return self.progressBar.css("width", "30%");
              case 11:
                _context2.next = 13;
                return formData.append("id_tahun_ajar", self.idTahunAjar.val());
              case 13:
                _context2.next = 15;
                return self.progressBar.css("width", "45%");
              case 15:
                _context2.next = 17;
                return formData.append("id_kelas", self.idKelas.val());
              case 17:
                _context2.next = 19;
                return self.progressBar.css("width", "60%");
              case 19:
                    ...
                    var _success = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(response) {
                      return _regeneratorRuntime().wrap(function _callee$(_context) {
                        while (1) switch (_context.prev = _context.next) {
                          case 0:
                            _context.next = 2;
                            return self.progressBar.css("width", "100%");
                          case 2:
                            _context.next = 4;
                            return self.loadingMessage.hide();
                          case 4:
                            _context.next = 6;
                            return self.progressBar.css("width", "0%");
                          case 6:
