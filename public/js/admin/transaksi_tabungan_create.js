...
(() => {
/*!*********************************************************!*\
  !*** ./resources/js/admin/transaksi_tabungan_create.js ***!
  \*********************************************************/
__webpack_require__.r(__webpack_exports__);
  ...
  _createClass(Main, [{
    ...
    value: function setListener() {
      ...
      $("#form-transaksi-tabungan").submit(function (event) {
        ...
        var url = "".concat(self.mainURL, "/api/transaksi-tabungan");
        var method = "post";
        var dataBody = {
    ...
    value: function setInputNomorRekening(idTahunAjar) {
      var idKelas = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "";
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                _context.next = 6;
                return self.setInputNomorRekening(self.tahunAjarSelected);
              case 6:
                self.fetchNamaKelas(self.tahunAjarSelected);
              case 7:
              case "end":
