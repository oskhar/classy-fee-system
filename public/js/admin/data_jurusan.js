  ...
  _createClass(Main, [{
    ...
    value: function setDataTable(tableElement) {
      ...
      return tableElement.DataTable({
        ajax: {
          url: "".concat(this.mainURL, "/api/jurusan/untuk-tabel"),
          type: "GET",
        ...
        columns: [{
          ...
          render: function render(data, type, row) {
            return "\n                        <a class=\"btn btn-outline-primary btn-sm\" href=\"".concat(_this2.mainURL, "/admin/data-jurusan-detail/").concat(data, "\">\n                            <i class=\"fas fa-eye\"></i>\n                        </a>\n                        <a class=\"btn btn-outline-warning btn-sm\" href=\"").concat(_this2.mainURL, "/admin/data-jurusan-update/?id_jurusan=").concat(data, "\">\n                            <i class=\"fas fa-pencil-alt\"></i>\n                        </a>\n                        <a class=\"btn btn-outline-danger btn-action btn-sm delete\" data-id=\"").concat(data, "\" data-nama=\"").concat(row.nama_jurusan, "\">\n                            <i class=\"fas fa-trash\"></i>\n                        </a>\n                    ");
          }
        }],
        responsive: true,
        lengthChange: false,
